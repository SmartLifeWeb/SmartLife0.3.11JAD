...
<html lang="en" style="height: 100%; margin: 0px;">
    ...
    function cierraact(id){
      
        document.getElementById("contact"+id).style.visibility="hidden ";
    ...
    <body style="height: 100%; margin: 0px;">
        ...
        <div class="cuerpo">
            <form action="agenda.jsp" method="post" name="creacion">
                ...
                <br>
                Fecha de inicio  <input type="datetime-local" name="fechainicio">
                <br>
                Fecha de termino  <input type="datetime-local" name="fechatermino">
                <br>
           ...
           ResultSet r=null; 
            ...
            r=sta.executeQuery("SELECT * FROM actividad where idUsuario='"+nombrebusqueda+"' order by Prioridad desc;");
            ...
            while(r.next()){
                ...
                out.println("<div class='principalact' onclick='mostraractividad(this.id)' id='"+contador+"'>"+actividad+"</div>");
                 ...
                 out.println("<div class='saliract' onclick='cierraact(this.id)' id='"+contador+"'><img class='sal' src='../../menu/close.png'></div>");
