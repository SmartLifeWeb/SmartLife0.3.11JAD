...
insert into tipoactividad values (default,'Tareas');
insert into tipoactividad values (default,'Actividad cultural');
insert into tipoactividad values (default,'Actividad deportiva');
insert into tipoactividad values (default,'Personal');
insert into tipoactividad values (default,'Del proyecto');
